...
#inputs
file = "Documents/X/2A/PSC/exemples de formats/10.events.xml" #this is the event file generated by MATsim
mapfile = "Documents/X/2A/PSC/exemples de formats/sample_network.xml" #this is the network file
pollutant = ["NOX","PM"] #the pollutant studied

#outputs
emissions_file = "Documents/X/2A/PSC/exemples de formats/total_emissions.csv" #gives the emission for each hour for each link in the ARIA format
map_csv_file = "Documents/X/2A/PSC/exemples de formats/map.csv" #gets the network in the simplest format
...
output_file_center = "Documents/X/2A/PSC/exemples de formats/lineic_emissions.csv" #gives the emission for each hour for each rectangle in the ARIA format
surface_network = "Documents/X/2A/PSC/exemples de formats/srf_network.csv" #a division of the zone in rectangles compatible with ARIA
lineic_network = "Documents/X/2A/PSC/exemples de formats/lineic_network.csv" #gets the network in a form compatible with ARIA for the chronological emissions
            ...
            for pol in pollutant:
                ...
                if amount>0:
                    ...
                    if pol in emissions[str(time)][matsim_id_to_int(link)].keys():
                        emissions[str(time)][matsim_id_to_int(link)][pol] += amount/1000 #g into kg
                    else :
                        emissions[str(time)][matsim_id_to_int(link)][pol] = amount/1000 #g into kg
